...
namespace GameFrameworks 
{
    ...
    #region VARIABLES & PROPERTIES
        private const string MaxSdkKey = "KEY HERE";
    ...
    #else // UNITY_ANDROID
        private const string InterstitialAdUnitId = "ID_HERE";
        ...
        private const string BannerAdUnitId = "ID_HERE";
    ...
    #region UNITY_EVENTS
        ...
        private void Start() {
            ...
            Observable.TimerFrame(Mathf.RoundToInt(5.0f/Time.deltaTime)).Subscribe(_=> {
    ...
    #region Interstitial Ad Methods
        ...
        {
            if(interstitialStatusText) interstitialStatusText.text = "Loading...";
        ...
        public void ShowInterstitial()
        {
            ...
            {
                if(interstitialStatusText) interstitialStatusText.text = "Showing";
                MaxSdk.ShowInterstitial(InterstitialAdUnitId);
            }
            else
            {
                if(interstitialStatusText) interstitialStatusText.text = "Ad not ready";
            }
        }
        ...
        private void OnInterstitialLoadedEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            ...
            if(interstitialStatusText) interstitialStatusText.text = "Loaded";
        ...
        private void OnInterstitialFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
        {
            ...
            if(interstitialStatusText) interstitialStatusText.text = "Load failed: " + errorInfo.Code + "\nRetrying in " + retryDelay + "s...";
        ...
        public void ToggleBannerVisibility()
        {
            ...
            if (!isBannerShowing)
            {
                ...
                if(showBannerButton) showBannerButton.GetComponentInChildren<Text>().text = "Hide Banner";
            }
            else
            {
                MaxSdk.HideBanner(BannerAdUnitId);
                Debug.Log("HIDE BANNER!");
                if(showBannerButton) showBannerButton.GetComponentInChildren<Text>().text = "Show Banner";
            }
    ...
    {
        internal static void trackAdRevenue(AdjustAdRevenue adjustAdRevenue)
        {
            throw new NotImplementedException();
        }
    }

    internal class AdjustConfig
    {
        public static object AdjustAdRevenueSourceAppLovinMAX { get; internal set; }
    }

    internal class AdjustAdRevenue
    {
        private object adjustAdRevenueSourceAppLovinMAX;

        public AdjustAdRevenue(object adjustAdRevenueSourceAppLovinMAX)
        {
            this.adjustAdRevenueSourceAppLovinMAX = adjustAdRevenueSourceAppLovinMAX;
        }

        internal void setAdRevenueNetwork(string networkName)
        {
            throw new NotImplementedException();
        }

        internal void setAdRevenuePlacement(string placement)
        {
            throw new NotImplementedException();
        }

        internal void setAdRevenueUnit(string adUnitIdentifier)
        {
            throw new NotImplementedException();
        }

        internal void setRevenue(double revenue, string v)
        {
            throw new NotImplementedException();
        }
    }
