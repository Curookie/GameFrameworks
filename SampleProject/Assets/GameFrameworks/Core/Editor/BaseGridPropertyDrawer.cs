...
// namespace GameFrameworks.Grid
// {
//     [CustomPropertyDrawer(typeof(BaseGrid))]
//     public class BaseGridPropertyDrawer : PropertyDrawer
//     {
...
//             EditorGUI.LabelField(widthRect, nameof(BaseGrid.Width), width.ToString());
...
//         private void BuildTableInventory(Rect position, int width, int height, ItemData[,] inventoryItemsSlot)
//         {
//             position.y += LineSpace + MarginTopField + 12;

//             EditorGUI.LabelField(new Rect(position.x, position.y, position.width, LineSpace),
//                 nameof(BaseGrid.Cells));
